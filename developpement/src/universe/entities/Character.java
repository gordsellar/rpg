...
public class Character extends Entity {
	...
	c.killer = this;
	Item lastWill = (Item) DatabaseManager.create(Item.class,
		"Letter from " + this.getName() + " : This is what I know, "
			+ "i hope it don't get lost", 1, true);
	for (Knowledge k : this.getKnowledges()) {
	    lastWill.addKnowledge(k);
	}
	c.addItem(lastWill);
