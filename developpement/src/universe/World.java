...
public class World {
     ...
     * Another Roger m.setWorld(w); Item i = new Item("Candle", 500, true);
     * i.setWorld(w); Item j = new Item("Match", 1, true); j.setWorld(w);
     * n.addItem(i); w.addEntity(n, new Position(0, 1)); w.addEntity(m, new
